...
import PedagogiChecklistDiagram from '@/components/PedagogicchecklistDiagram'
...
const PedagogicChecklist = async ({ params: { id } }: Props) => {
	const interview = await readOne(id)
	const criterais = await readOneCriterias('pedagogical_checklist')
		...
		<>
			<div className='container'>
				<ClientInfoHead
					...
					title={'Pedagogisk checklista'}
					info={''}
				/>
				<PedagogiChecklistDiagram
